...
public class Runner {
    ...
    public static void main(String[] args) throws Exception {
        ...
        LOGGER.info(
            "Running program with parameters: rootProjectDirectory=" + rootProjectDirectory + " ,reportConcatDirectory="
                + reportConcatDirectory + " ,pitReportDirectory=" + pitReportDirectory);

        ReportConcat reportConcat = new ReportConcat();
        reportConcat.run(rootProjectDirectory, reportConcatDirectory, pitReportDirectory);
    }
}
